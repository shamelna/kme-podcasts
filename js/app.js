...
class PodcastApp {
    ...
    async init() {
        try {
            ...
            // Add small delay to show loading screen (remove this in production)
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('./service-worker.js')
            .then(registration => {
                ...
                // Periodic sync disabled - using fallback auto-update every 24 hours
                console.log('Using fallback auto-update every 24 hours');
            })
            .catch(error => {
